...
use marvin255\bxmigrate\cli\SymphonyRefresh;

class SymphonyRefreshTest extends BaseCase
{
    /**
     * @test
     */
    public function testExecute()
    {
        ...
        $manager = $this->getMockBuilder('\\marvin255\\bxmigrate\\IMigrateManager')
            ...
            ->getMock();
        $manager->expects($this->once())->method('refresh')->with($this->equalTo($name));
